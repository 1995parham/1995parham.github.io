	...
	return (
		<>
			<Head>
				...
				<link
					rel="canonical"
					href={`https://1995parham.github.io${router.asPath === "/" ? "" : router.asPath}`}
				/>
				...
				<meta
					property="og:title"
					content="Parham Alvani - Senior Software & Platform Engineer"
				/>
				<meta
				...
				<meta
					property="og:image"
					content="https://1995parham.github.io/parham-alvani-profile.png"
				/>
				<meta
					property="og:image:alt"
					content="Parham Alvani - Software Engineer"
				/>
				...
				<script
					...
					// biome-ignore lint/security/noDangerouslySetInnerHtml: static, build-time JSON-LD structured data with no user input
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							description:
								"Software engineer with a Ph.D. and 10+ years of experience building backend systems and cloud-native platforms.",
								...
								<div className="sidebar-title">
									...
									<div className="divider">
										<div
											...
											className="zigzag large clearfix"
										>
											<svg
												aria-hidden="true"
												xmlSpace="preserve"
