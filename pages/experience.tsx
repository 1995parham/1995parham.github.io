...
function Experience() {
	return (
		<>
			<Head>
				<title>
					Work Experience - Parham Alvani | Senior Software Engineer
				</title>
				<meta
					name="description"
				...
				<div className="experience">
					...
					<div className="content d-grid gap-5">
						...
						<div className="text-body">
							...
							<ul>
								<li>
									Spearheaded the development of a new doctors panel using
									Python and React, successfully migrating users from the old
								...
								<li>
									Built an AI-powered transcription pipeline using Deepgram,
									RAG, and Pydantic AI to transcribe doctor-patient sessions and
						...
						<div className="text-body">
							...
							<ul>
								...
								<li>
									...
									high-volume delivery application, leveraging NATS to handle
									over 300k messages/sec.
								</li>
								<li>
						...
						<div className="text-body">
							...
							<ul>
								...
								<li>
									...
									agricultural monitoring, utilizing Sentinel-2 satellite
									imagery for crop insights.
								</li>
							</ul>
						</div>
					</div>
