						...
						<div className="row">
							<div className="col-md-8 text-body">
								<p>
									...
									architecture, with hands-on success engineering
									high-throughput solutions handling 300,000+ messages/sec.
								</p>
								<br />
								<p>
									My journey began in 2012 at Amirkabir University of
									Technology, where my first programming course with{" "}
									<a href="https://ce.aut.ac.ir/~bakhshis/">Prof. Bakhshi</a>{" "}
									sparked my passion for Unix, Linux, and the world of
									computing.
								</p>
								<br />
								<p>
									I am deeply interested in networks and their applications in
									Internet of Things. As a researcher, I love hands-on
									work—building real systems rather than theoretical models. My
									Ph.D. research focused on practical IoT solutions and network
									protocols.
								</p>
								<br />
								<p>
									As a developer, I thrive on solving complex challenges,
									understanding root causes, and optimizing performance. My
									track record spans full-stack development, distributed systems
									design, and platform engineering—from writing production
									services to architecting company-wide infrastructure.
								</p>
								<br />
								<Image
